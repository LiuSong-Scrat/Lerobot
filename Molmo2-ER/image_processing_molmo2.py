...
def select_tiling(h, w, patch_size, max_num_crops):
    ...
    # ``dtype=`` for np.stack was added in NumPy 1.24. Keep this processor
    # compatible with the project's reap environment (NumPy 1.23.x).
    original_size = np.stack([h, w]).astype(np.float32, copy=False)  # [1, 2]
