...
required_v52_commit=9447a43a0e2ed3130a578618ac92225f71eb8a31
...
[[ "$(git -C "$repo" rev-parse HEAD)" == "$required_v52_commit" ]] || {
  echo "V52 executable HEAD must be $required_v52_commit" >&2
  exit 3
}
