...
session=wep_v043_v51r1childenvfix_all_candidates_full500_2x2_gate
worker="$root/scripts/wait_then_run_v51r1_all_candidates_full500_2x2_causal_gate.sh"
log="$root/joint_multiview_worldflow/libero10_500ep/logs/eval_v51r1childenvfix_all_candidates_full500_2x2_gate.log"
