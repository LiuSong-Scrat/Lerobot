...
runner=$root/scripts/run_v51r1_from_v32step100_multiscale1cm4cm_paired_symmetricpoint5e8_policy5e9_schemafix_4gpu_b44_w12_1564steps.sh
session=wep_v043_v51r1_schemafix_conservative_symmetricpoint_paired_train
log=$root/joint_multiview_worldflow/libero10_500ep/logs/coordinator_v51r1_schemafix_conservative_symmetricpoint_paired_train.log
