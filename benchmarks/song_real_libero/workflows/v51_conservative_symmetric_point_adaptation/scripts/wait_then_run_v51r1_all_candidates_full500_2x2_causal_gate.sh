...
screen="$artifact_root/v51r1eglfix_all_checkpoints_stratified_3arm_multiview_worldflow_screen.json"
screen_session=wep_v043_v51r1eglfix_all_checkpoints_stratified_3arm
aggregate="$artifact_root/v51r1eglfix_all_candidates_full500_2x2_multiview_worldflow_causal_gate.json"
...
for step in "${candidate_steps[@]}"; do
  ...
  step_gate="$artifact_root/v51r1eglfix_step${step6}_full500_2x2_multiview_worldflow_causal_gate.json"
