...
optimizer_preflight=$run_root/artifacts/v51_real_checkpoint_optimizer_and_gradient_role_preflight_v2.json
optimizer_preflight_script=$root/scripts/audit_v49_real_checkpoint_optimizer_preflight.py
output=$run_root/training/v51_from_v32step100_multiscale_novelty1cm4cm_paired_symmetricpoint5e8_policy5e9_devicebound_4gpu_b44_w12_1564steps
log=$run_root/logs/train_v51_from_v32step100_multiscale_novelty1cm4cm_paired_symmetricpoint5e8_policy5e9_devicebound_4gpu_b44_w12_1564steps.log
...
exec "$python" -m accelerate.commands.launch \
  ...
  --job_name=wep_vla_v043_v51_v32step100_multiscale1cm4cm_paired_symmetricpoint5e8_policy5e9_devicebound_b44_1564 \
  ...
  --wandb.run_id=joint-v51-v32step100-multiscale1cm4cm-paired-symmetricpoint5e8-policy5e9-devicebound-b44-20260815 \
