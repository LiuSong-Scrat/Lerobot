...
aggregate="$artifact_root/v51r1_all_checkpoints_stratified_3arm_multiview_worldflow_screen.json"
...
for step in "${steps[@]}"; do
  ...
  step_artifact="$artifact_root/v51r1_step${step6}_stratified_3arm_multiview_worldflow_screen.json"
