...
session=wep_v043_v51r1childenvfix_all_checkpoints_stratified_3arm
worker="$root/scripts/wait_then_screen_v51r1_all_checkpoints_stratified_3arm.sh"
log="$root/joint_multiview_worldflow/libero10_500ep/logs/eval_v51r1childenvfix_all_checkpoints_stratified_3arm.log"
