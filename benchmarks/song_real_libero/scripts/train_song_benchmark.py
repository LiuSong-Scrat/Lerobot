...
def write_full_molmo2er_parameter_audit(
    ...
    payload = {
        ...
        "prefix_attention": backend.architecture_contract.get("prefix_attention"),
        "prefix_token_order": backend.architecture_contract.get("prefix_token_order"),
        "prefix_position_ids": backend.architecture_contract.get("prefix_position_ids"),
