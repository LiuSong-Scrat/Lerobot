...
ROOT = PROJECT_ROOT / "data" / "lerobot_dataset"
HDF5_FOLDER = PROJECT_ROOT / "data" / "hdf5_clean"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--task", default=None, help="Override all episode task strings. Defaults to HDF5 task_name or a cube task.")
