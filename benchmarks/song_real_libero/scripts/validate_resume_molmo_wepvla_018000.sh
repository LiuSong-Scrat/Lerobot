...
validation_output=/opt/data/private/liusong/benchmarks/song_real_libero/outputs/lerobot_7B_molmo2_song/full_molmo2er_worldflow/molmo_wepvla_contract_18l_native64_after2w6_recovery_validation
...
exec /home/liusong/anaconda3/envs/reap/bin/python -m accelerate.commands.accelerate_cli launch \
  ...
  --job_name=molmo_wepvla_018000_recovery_validation \
  --steps=18001 \
