...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Camera to store as both RGB and point cloud. Repeat for multiple views. "
            "The first camera keeps the legacy point_clouds/ directory."
        ),
    )
...
def main() -> None:
    ...
    elif image_camera_value is not None:
        cfg["image_cameras"] = [normalize_camera_name(str(image_camera_value))]
    else:
        cfg["image_cameras"] = image_feature_cameras(cfg)
