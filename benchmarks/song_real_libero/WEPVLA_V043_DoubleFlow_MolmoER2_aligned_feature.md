...
```
  ...
  grep -E 'libero_pointcloud_eval|multiprocessing.spawn|multiprocessing.resource_tracker'
  ...
  CUDA_VISIBLE_DEVICES=0 \
  MUJOCO_EGL_DEVICE_ID=0 \
  SONG_LIBERO_ENV_CUDA_VISIBLE_DEVICES=0,3 \
  SONG_LIBERO_ENV_MUJOCO_EGL_DEVICE_ID=3 \
  PYTHONPATH=/home/liusong/ProgramFiles/Huggingface/lerobot_7B_molmo2_song/src:/home/liusong/ProgramFiles/Huggingface/lerobot_7B_molmo2_song \
  /home/liusong/anaconda3/envs/reap/bin/python \
    benchmarks/song_real_libero/scripts/libero_setting/libero_pointcloud_eval.py \
    --config benchmarks/song_real_libero/configs/libero.json \
    --policy.path /opt/data/private/liusong/benchmarks/song_real_libero/outputs/lerobot_7B_molmo2_song/full_molmo2er_worldflow/molmo_wepvla_4suite40tasks_from55k_after_90k_after50k_NEWDATA_after48k/checkpoints/052000/pretrained_model \
    --device cuda \
    --suite libero_10 \
    --task-id 6 \
    --episodes 50 \
    ...
    --control-freq 20 \
    --action-index 0 \
    --exec-action-steps 22 \
    --adaptive-exec-max-steps 2 \
    --grasp-exec-steps 22 \
    --max-steps 1000 \
    --no-use-suite-max-steps \
    --recreate-env-per-episode \
    ...
    --save-video \
    --no-world-to-ego-causal-ablation \
    --output-dir benchmarks/song_real_libero/outputs/temp_test38_chunk22
...
-----------------------------
  ...
  /home/liusong/anaconda3/envs/reap/bin/python \
    benchmarks/song_real_libero/scripts/libero_setting/libero_pointcloud_eval.py \
    --config benchmarks/song_real_libero/configs/libero.json \
    --policy.path /opt/data/private/liusong/benchmarks/song_real_libero/outputs/lerobot_7B_molmo2_song/full_molmo2er_worldflow/molmo_wepvla_4suite40tasks_from55k_after_90k_after50k_NEWDATA_after48k/checkpoints/last/pretrained_model \
    --device cuda \
    --suite-gpu-ids 0,1,2,3 \
    --suite libero_spatial \
    --suite libero_object \
    ...
    --strict-official-init \
    --gripper-control-mode delta_width_initial_sync \
    --gripper-delta-threshold 0.0025 \
    --gripper-delta-alignment current_minus_previous \
    --waypoint-max-hold-steps 1 \
    --isolated-policy-workers 1 \
    --task-workers 10 \
    ...
    --save_umi_vis \
    --no-world-to-ego-causal-ablation \
    --output-dir benchmarks/song_real_libero/outputs/eval_temp_4suite_episode400_60k_chunk24_freq20_thresh25_1
