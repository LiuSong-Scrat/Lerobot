...
- exact-index审计通过后，V47已由waiter自动启动，tmux为`wep_v043_v47_multiscale_novelty_paired_train`。它从权威v32 step100开始，双/单视角paired coverage的`dataset.num_frames=275180`，4 GPU、batch48/GPU、worker12、1440步（至少一个完整paired epoch）、W&B enabled，四组参数统一有效LR `5e-8`，无冻结、无新增辅助loss或门控；输出为`joint_multiview_worldflow/libero10_500ep/training/v47_from_v32step100_multiscale_novelty1cm3cm_paired_uniformlr5e8_4gpu_b48_w12_1440steps`。启动审计确认worktree在干净commit `9b63311`，W&B run为`joint-v47-v32step100-multiscale-novelty-paired-uniformlr5e8-b48-20260815`，首20步loss/gradient均有限、无OOM/NaN，稳态约2.2--2.5秒/步，四卡显存约22.4--24.1GiB。
