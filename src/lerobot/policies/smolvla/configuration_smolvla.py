...
class SmolVLAConfig(PreTrainedConfig):
    ...
    # Scheme B keeps Full-Molmo2-ER outside the training graph. Each frozen
    # layer supplies detached IMAGE/TEXT K/V memory to the aligned Expert.
    molmo_inference_only: bool = True
