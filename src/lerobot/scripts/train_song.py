...
def _apply_song_debug_defaults() -> None:
    ...
    sys.argv = [
        ...
        "--log_freq=1",
        "--num_workers=12",
        "--output_dir=/opt/data/private/liusong/benchmarks/song_real_libero/outputs/lerobot_7B_molmo2_song/full_molmo2er_worldflow_three_stage/molmo_native_readonly_scene_shadow_wepvla_expert_v5_long68_single_gpu_debug",
        "--job_name=molmo_native_readonly_scene_shadow_wepvla_expert_v5_long68_single_gpu_debug",
        "--policy.device=cuda",
        "--wandb.enable=true",
