...
def _apply_song_debug_defaults() -> None:
    ...
    sys.argv = [
        ...
        #"--pointseg_sample_cache_dir=/opt/data/private/liusong/benchmarks/song_real_libero/data/real_setting/ep_vla_v03_adapter_cache_v7_data/ep_vla_v03_adapter_cache_v7",
