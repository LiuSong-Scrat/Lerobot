...
def _apply_song_debug_defaults() -> None:
    ...
    sys.argv = [
        "train_song.py",
        # "--policy.path=/home/liusong/ProgramFiles/Huggingface/lerobot/outputs/train/my_smolvla_song_pointseg_worldflow1/checkpoints/last/pretrained_model",
        "--policy.type=smolvla",
        ...
        "--steps=500000",
        "--log_freq=1",
        "--output_dir=/home/liusong/ProgramFiles/Huggingface/lerobot/outputs/train/my_smolvla_song_pointseg_worldflow_se3",
