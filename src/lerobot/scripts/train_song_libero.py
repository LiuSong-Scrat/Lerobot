...
def _apply_song_debug_defaults() -> None:
    ...
    sys.argv = [
        ...
        "--dataset.repo_id=/opt/data/private/liusong/benchmarks/song_real_libero/data/libero_setting/wep_vla_v042_general_data/libero_4suite_lerobot_dataset",
        #"--pointseg_sample_cache_dir=/opt/data/private/liusong/benchmarks/song_real_libero/data/libero_setting/wep_vla_v042_general_data/libero_4suite_lerobot_toolseg_cache",
